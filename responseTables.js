export const fakeResponses = [
  ...
  ["Woah, you might actually have a point there", 3],
...
export const thinkingResponses = [
  ...
  ["Hmmm...", 2],
  ["Hold on, I'm fact checking that...", 1],
  ["Lemme look into that.", 1],
...
export const simpleResponses = [
  ...
  ["I don't think that's accurate", 5],
  ["Maybe you should look into that one (it's wrong)", 6],
  ["Is there any way you could be more wrong about that?", 8],
  ["That is simply untrue.", 3],
  ["The fact is, no.", 2],
  ["Nope.", 1],
  ["lol nah", 1],
  ["If you could be any more wrong, we would applaud. 👏", 3],
  ["You're so cute when your're incorrect.", 4],
  ["There is a 91.3458763245% chance you are not correct about that.", 1],
  ["Wanna try that one again?", 3],
  ["👏 WAT 👏 IS 👏 U 👏 SAYING? ", 2],
  [
